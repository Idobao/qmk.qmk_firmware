...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L0] = LAYOUT_all(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(_L1), MO(_L1), KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT
    ),
    ...
    [_L1] = LAYOUT_all(
        ...
        _______, _______, _______,                            _______,                            _______, KC_APP,  _______, _______, _______, _______, _______, _______, _______
    )
};
